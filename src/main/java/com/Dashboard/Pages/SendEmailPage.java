...
public class SendEmailPage extends BaseClass {
	...
	public void sendEmail(String txt_To, String txt_Bcc, String txt_CC, String txt_Subject, String txt_Body) throws InterruptedException {
		...
		//WebDriverWait waitForMessageBody = new WebDriverWait(driver,Duration.ofSeconds(30));
		//waitForMessageBody.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//div[starts-with(@id,'cke_1_contents')]//iframe")))).sendKeys(Keys.TAB);
	...
	public void wait_for_alert() {
		...
		Assert.assertEquals(alertWait,alertWait,
				"Mail not sent, Kindly check the data in excel file, All six input fields are mandatory in excel");
